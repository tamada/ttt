...
func (ds *StandaloneDataStore) initImpl() error {
	if err := loadJson(COURSES_JSON, &ds.courses); err != nil {
		return err
	}
	if err := loadJson(LECTURES_JSON, &ds.lectures); err != nil {
		return err
	}
	return nil
}
